...
namespace Narzedzia.Data.Migrations
{
    ...
    [Migration("20240109151432_tescik202432334")]
    partial class tescik202432334
    {
            ...
            modelBuilder.Entity("Narzedzia.Models.Events", b =>
                {
                    ...
                    b.Property<int?>("NarzedzieId1")
                        .HasColumnType("int");

                    b.Property<int?>("StanowiskoId")
                        .HasColumnType("int");

                    b.Property<int?>("StanowiskoId1")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("NarzedzieId1");

                    b.HasIndex("StanowiskoId");

                    b.HasIndex("StanowiskoId1");

                    b.HasIndex("WydzialId");

                    b.HasIndex("WydzialId1");
            ...
            modelBuilder.Entity("Narzedzia.Models.Events", b =>
                {
                    ...
                    b.HasOne("Narzedzia.Models.Narzedzie", null)
                        .WithMany("Events")
                        .HasForeignKey("NarzedzieId1");

                    b.HasOne("Narzedzia.Models.Stanowisko", "Stanowisko")
                        .WithMany()
                        .HasForeignKey("StanowiskoId");

                    b.HasOne("Narzedzia.Models.Stanowisko", null)
                        .WithMany("Events")
                        .HasForeignKey("StanowiskoId1");

                    b.HasOne("Narzedzia.Models.Wydzial", "Wydzial")
                        .WithMany()
                        .HasForeignKey("WydzialId");

                    b.HasOne("Narzedzia.Models.Wydzial", null)
                        .WithMany("Events")
                        .HasForeignKey("WydzialId1");
